        ...
        {!loading && (
                ...
                <div className="cont">
                    <div className="side">
                        ...
                        <div className="create-group" onClick={() => setShowCreateModal(!showCreateModal)}>
                          <p>Create Quiz</p>
                                  ...
                                  return (
                                    ...
                                    <div className="tabs"  style={{display:(data[index].name === group && open) ? "block":"none"}}>
                                        ...
                                        <div className="type-count">
                                            ...
                                            <p className="side-bar-item">{quizCounts[idx].completed}</p>
                                        </div>
                                    </div>
                                  </>
                                  )
                    ...
                    {(activequiz.length > 0 && upcoming == false && completed == false && data.length > 0) && (
                              ...
                              <div className="active-quiz-description">
                                ...
                                <p className="instructions-box">
                                  ...
                                  <p className="end">
                                    ...
                                    id={quiz.id}/> */}
                                     <div className="but">
                                     <button className="view" onClick={() => history.push(`/quizquestions/${quiz.id}`)}>View</button>
                                          <EditQuiz 
                                          id={quiz.id}
                                          title={quiz.title}
                                          desc={quiz.desc}
                        ...
                        {(upcomingquiz.length > 0 && active == false && completed == false && data.length > 0)  && (
                          <div className="active">
                          <div className="active-active">
                        ...
                        {(completedquiz.length > 0 && active == false  && upcoming == false && data) && (
                          <div className="active">
                          <div className="active-active">
                              <p className="active-title">{data[index].name} - Completed</p>
                          </div>
                          ...
                          {(completedquiz.length == 0 && active == false  && upcoming == false && data.length > 0) && (
                                 <div className="active">
                                    <div className="active-active">
