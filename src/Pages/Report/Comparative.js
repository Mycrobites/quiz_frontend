...
function Comparative() {
  ...
  const fetchReportId = async () => {
    ...
    try {
      ...
      const { data } = await axios.get(`api/getstudentresult/599`, config);
      if (data) {
        setIsLoading(false);
      }
                ...
                {available && (
                  <>
                    ...
                    <tr>
                      ...
                      <td className="col-2">
                        {comparativedata["data"].marks_obtained}/
                        {comparativedata["average"].totalquestion * 4}
                      </td>
                      <td className="col-3">
                        {comparativedata["average"].marks_obtained}/
                        {comparativedata["average"].totalquestion * 4}
                      </td>
                      <td className="col-4">
                        {comparativedata["topper"].marks_obtained}/
                        {comparativedata["average"].totalquestion * 4}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="col-2">
                        {`${
                          (comparativedata["data"].correctquestion /
                            comparativedata["data"].attempted) *
                          100
                        }`}{" "}
                        %
                      </td>
                      <td className="col-3">
                        {`${
                          (comparativedata["average"].correctquestion /
                            comparativedata["average"].attempted) *
                          100
                        }`}{" "}
                        %
                      </td>
                      <td className="col-4">
                        {`${
                          (comparativedata["topper"].correctquestion /
                            comparativedata["topper"].attempted) *
                          100
                        }`}{" "}
                        %
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="col-2">
                        {comparativedata["data"].not_attempted}
                      </td>
                      <td className="col-3">
                        {comparativedata["average"].not_attempted}
                      </td>
                      <td className="col-4">
                        {comparativedata["topper"].notattempted}
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="col-2">
                        {comparativedata["data"].incorrectquestion}
                      </td>
                      <td className="col-3">
                        {comparativedata["average"].incorrectquestion}
                      </td>
                      <td className="col-4">
                        {comparativedata["topper"].incorrectquestion}
                      </td>
                    </tr>
                  </>
                )}
